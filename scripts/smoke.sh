...
chk "EMP GET /api/campaigns -> 403" 403 "$(code emp /api/campaigns)"
chk "OWNER GET /api/campaigns -> 200" 200 "$(code owner /api/campaigns)"
chk "EMP GET /api/audit -> 403" 403 "$(code emp /api/audit)"
chk "OWNER GET /api/audit -> 200" 200 "$(code owner /api/audit)"
...
for p in /dashboard /floor /kds /schedule /time /availability /sop /recipes /checklists /production /inventory /messages /performance /security /tasks /waste /incidents /vacation /assistant; do
